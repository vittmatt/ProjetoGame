...
public class PlayStation extends ConsoleComDisco implements Console {
    ...
    public void abrirJogo(String jogo) throws TrocaJogoInvalidaException {
        ...
        if (this.getTemDisco()) {
            System.out.println("Você está trocando de jogo no br.com.projetoGame.classes.PlayStation");
            return;
        }
    ...
    public void desligar() throws ImpossivelDesligarException {
        ...
        System.out.println("Desligando o br.com.projetoGame.classes.PlayStation");
    ...
    public void ligar() throws ImpossivelLigarException {
        ...
        System.out.println("Ligando o br.com.projetoGame.classes.PlayStation");
    }
